<main class="flex-grow container mx-auto px-4 md:px-8 py-12">
            ...
            <div id="loans" class="bg-white rounded-2xl shadow-sm border border-[#E6DCCF] overflow-hidden">
                <div class="px-6 py-5 border-b border-[#F2EFE9] bg-[#FDFBF7]">
                    <h3 class="font-bold text-lg text-[#4A4036] flex items-center gap-2">
                        <svg class="w-5 h-5 text-[#8C7B6C]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-[#F2EFE9] text-sm">
                            ...
                            <tr class="hover:bg-[#FDFBF7] transition-colors">
                                <td class="px-6 py-4 font-bold text-[#4A4036]">The Old Library</td>
                                <td class="px-6 py-4 text-[#6B5D52]">A. H. Anderson</td>
                                <td class="px-6 py-4"><span class="bg-[#F2EFE9] text-[#4A4036] px-2 py-1 rounded-md text-xs font-bold">Classic</span></td>
                                <td class="px-6 py-4 text-right">
                             ...
                             <tr class="hover:bg-[#FDFBF7] transition-colors">
                                <td class="px-6 py-4 font-bold text-[#4A4036]">Atomic Habits</td>
                                <td class="px-6 py-4 text-[#6B5D52]">James Clear</td>
                                <td class="px-6 py-4"><span class="bg-[#F2EFE9] text-[#4A4036] px-2 py-1 rounded-md text-xs font-bold">Self Help</span></td>
                                <td class="px-6 py-4 text-right">
                                    <button class="text-red-500 hover:text-red-700 p-2 hover:bg-red-50 rounded-full transition-colors" title="Delete Book">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                    </button>
    ...
    <div id="addBookModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
        <div class="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden animate-fade-in-up">
            ...
            <form action="/admin/books/add" method="POST" class="p-8 space-y-6">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-2">
                        <label class="block text-sm font-bold text-[#4A4036] mb-2">Book Title</label>
                        <input type="text" name="title" required placeholder="e.g. The Hobbit"
                            class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] rounded-lg p-3 focus:ring-[#4A4036] focus:border-[#4A4036]">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-[#4A4036] mb-2">Author Name</label>
                        <input type="text" name="author_name" required placeholder="e.g. J.R.R. Tolkien"
                            class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] rounded-lg p-3 focus:ring-[#4A4036] focus:border-[#4A4036]">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_of_distrubution" required
                            class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] rounded-lg p-3 focus:ring-[#4A4036] focus:border-[#4A4036]">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-[#4A4036] mb-2">Linked Author Account</label>
                        <select name="author_id" class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] rounded-lg p-3 focus:ring-[#4A4036] focus:border-[#4A4036]">
                            <option value="1">John Doe (ID: 1)</option>
                            <option value="5">Sarah Connor (ID: 5)</option>
                        </select>
                        <p class="text-xs text-[#8C7B6C] mt-1">Select the registered user who wrote this.</p>
                    </div>
                </div>
