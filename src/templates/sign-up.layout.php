    ...
    <div class="bg-white rounded-3xl shadow-xl border border-[#E6DCCF] overflow-hidden max-w-5xl w-full flex flex-col md:flex-row min-h-[600px]">
        ...
        <div class="hidden md:block w-1/2 relative">
            ...
            <div class="absolute inset-0 bg-[#4A4036] bg-opacity-40 flex flex-col justify-between p-12">
                <div>
                    <img src="/img/library_logo.png" alt="Logo" class="h-16 w-auto opacity-90 mb-4">
                </div>
                <div>
            ...
            <form action="#" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input value="<?= !isset($reader) ? '' : $reader->get_first_name() ?>" type="text" id="first_name" name="first_name" placeholder="Sarah" required
                    ...
                    <div>
                        ...
                        <input value="<?= !isset($reader) ? '' : $reader->get_last_name() ?>" type="text" id="last_name" name="last_name" placeholder="Connor" required
                            class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] text-sm rounded-lg focus:ring-[#4A4036] focus:border-[#4A4036] block p-3 placeholder-[#8C7B6C] transition-colors">
                        <?php
                ...
                <div>
                    ...
                    <input value="<?= !isset($reader) ? '' : $reader->get_email() ?>" type="email" id="email" name="email" placeholder="name@company.com" required
                        class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] text-sm rounded-lg focus:ring-[#4A4036] focus:border-[#4A4036] block p-3 placeholder-[#8C7B6C] transition-colors">
                    <?php
                ...
                <div>
                    ...
                    <input value="<?= !isset($reader) ? '' : $reader->get_phone_number() ?>" type="tel" id="phone_number" name="phone_number" placeholder="+212 6 00 00 00 00"
                        class="w-full bg-[#FDFBF7] border border-[#E6DCCF] text-[#4A4036] text-sm rounded-lg focus:ring-[#4A4036] focus:border-[#4A4036] block p-3 placeholder-[#8C7B6C] transition-colors">
                    <?php
